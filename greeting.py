...
def respondMessage():
    ...
    print(request_data)
    #return request_data
    url = 'https://613d-2603-7000-9200-966a-25dd-cda-2667-33e2.ngrok-free.app/msg'
    ...
    data = {
        ...
        "send_style": "",
        "media_url": "",
        "status_callback": "https://613d-2603-7000-9200-966a-25dd-cda-2667-33e2.ngrok-free.app/msg"
    }
    print("IN HERE")
